...
typedef enum
{
	...
	RF_NOAFFINE				= 0x00010000,  // Disables affine drawing for this sprite

	RF_AFFINEPRESCALE    = 0x00020000,  // Makes affines scale before rotating, instead of rotating before scaling
} renderflags_t;
